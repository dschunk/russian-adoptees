...
if (contactForm) {
  contactForm.addEventListener('submit', (event) => {
    ...
    const mailto = new URL('mailto:david.schunk@russianadoptees.com');
    mailto.searchParams.set('subject', `[RAO Website] ${topic}: ${subject}`);
    mailto.searchParams.set('body', body);

    if (formStatus) {
      formStatus.textContent = 'Opening your email application with the inquiry prepared. Review it, then send.';
    }
